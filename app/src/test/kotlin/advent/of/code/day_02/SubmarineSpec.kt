...
class SubmarineSpec : Spek({
    Feature("Submarine Test") {
        Scenario("Calculate depth and horizontal position") {
            val testCases = mapOf(
                """forward 5
                    down 5
                    forward 8
            ...
            testCases.forEach {
                ...
                Then("depth multiplied to horizontal position should be the expected") {
                    assertEquals(it.value, submarine.horizontalPosition * submarine.depth)
                }
            }
        }
        Scenario("Calculate depth and horizontal position with aim") {
            val testCases = mapOf(
                """forward 5
                    down 5
                    forward 8
